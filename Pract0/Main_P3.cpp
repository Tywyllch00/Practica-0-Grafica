...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::mat4(1);
		model = glm::translate(view, glm::vec3(-6.0f, 4.0f, 2.0f));
		model = glm::rotate(model, 0.5f, glm::vec3(5.0f, 2.0f, 0.0f)); // use to compare orthographic and perspective projection
		...
		model = glm::mat4(1);
		model = glm::translate(view, glm::vec3(6.0f, 4.0f, 2.0f));
		model = glm::rotate(model, 0.5f, glm::vec3(4.0f, 2.0f, 3.0f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(3.0f, 8.0f, 5.0f));
