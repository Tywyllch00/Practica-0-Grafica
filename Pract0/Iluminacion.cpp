...
glm::vec3 lightPos2(0.9f, 0.9f, 1.5f);
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"), 0.8f, 0.4f, 0.4f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 0.8f, 0.8f, 0.4f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.specular"), 0.4f, 0.8f, 0.4f);


        //luz 2
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.ambient"), 0.2f, 0.1f, 0.3f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.diffuse"), 0.3f, 0.6f, 0.2f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.specular"), 0.7f, 0.1f, 0.2f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.0f, 0.0f, 0.6f);
