...
//For model
float	hombro = 0.0F, codo = 0.0f, muneca = 0.0f, dedo1 = 0.0f, falaje1 = 0.0f, dedo2 = 0.0f, falaje2= 0.0f, dedo3 = 0.0f, falaje3 = 0.0f;
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Model dedo1
		model = glm::translate(modelTemp, glm::vec3(0.25f, 0.2f, -0.3f));
		...
		model = glm::rotate(model, glm::radians(falaje1), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		//Model Flanje2
		model = glm::translate(modelTemp2, glm::vec3(0.3f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(falaje2), glm::vec3(0.0f, 1.0f, 0.0f));
		modelTemp2 = model = glm::translate(model, glm::vec3(0.2f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.4f, 0.2f, 0.2f));
		color = glm::vec3(1.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//Model Flanje3
		model = glm::translate(modelTemp2, glm::vec3(0.3f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(falaje3), glm::vec3(0.0f, 1.0f, 0.0f));
		modelTemp2 = model = glm::translate(model, glm::vec3(0.2f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.4f, 0.2f, 0.2f));
		color = glm::vec3(1.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
